...
- Be sure and commit your changes in your local git repo (in the
  /source/ branch).
- Branches
  - /source/ - this is where you compose everything
  - /master/ - this is what is served to the public from GitHub pages.
...
#+BEGIN_SRC emacs-lisp
  (when (require 'org-octopress nil :noerror)
    (setq org-octopress-directory-top "~/Documents/Personal/gordyt.github.io/source"
          ...
          org-octopress-setup-file (concat org-octopress-directory-top "/setupfile.org")
          ))
#+END_SRC
